...
namespace HotelManagement_FinalProject {
    ...
    public partial class QLSVDBDataSet : global::System.Data.DataSet {
        ...
        public partial class log_inDataTable : global::System.Data.TypedTableBase<log_inRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public log_inRow Addlog_inRow(int Id, string username, string password, string Email, string status) {
...
namespace HotelManagement_FinalProject.QLSVDBDataSetTableAdapters {
    ...
    public partial class log_inTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[log_in] ([Id], [username], [password], [Email], [status]) VALU" +
                "ES (@Id, @username, @password, @Email, @status);\r\nSELECT Id, username, password," +
                " Email, status FROM log_in WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[log_in] SET [Id] = @Id, [username] = @username, [password] = @password, [Email] = @Email, [status] = @status WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)));
SELECT Id, username, password, Email, status FROM log_in WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HotelManagement_FinalProject.Properties.Settings.Default.QLSVDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password, Email, status FROM dbo.log_in";
        ...
        public virtual int Fill(QLSVDBDataSet.log_inDataTable dataTable) {
        ...
        public virtual QLSVDBDataSet.log_inDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLSVDBDataSet.log_inDataTable dataTable = new QLSVDBDataSet.log_inDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLSVDBDataSet.log_inDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, string Original_Email, string Original_status) {
        ...
        public virtual int Insert(int Id, string username, string password, string Email, string status) {
        ...
        public virtual int Update(int Id, string username, string password, string Email, string status, int Original_Id, string Original_username, string Original_password, string Original_Email, string Original_status) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string Email, string status, int Original_Id, string Original_username, string Original_password, string Original_Email, string Original_status) {
            return this.Update(Original_Id, username, password, Email, status, Original_Id, Original_username, Original_password, Original_Email, Original_status);
        }
    }
